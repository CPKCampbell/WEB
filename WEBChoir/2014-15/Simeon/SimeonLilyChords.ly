...
dyntempi = {
  ...
  %57
\time 4/4   \tempo 4=92 s1*3 \tempo 4=88 s1
  %61
  \tempo 4=92 s1*4
  %65
  s1*2 s4 \tempo 4=90 s2. s4\>  s4 s2
  %69
  \time 2/2 s2\mp s2 s1*3
  %73
  s2\p s2 s1*2 s2 s2
  %77
  s2\mp s2 s1*3
...
rightOne = \relative c'' {
  ...
  \new Voice {
    ...
    < ef c bf>1~ < ef c bf>2 <ef c>4 ( < f d > ) |
    %5
    < bf g ef >2 < bf g ef > < bf a ef>1 < bf g ef >2 < bf g ef > < bf a ef>1  |
    %9
    < bf g ef >2 < bf g ef > < bf a ef>1 < bf g ef >2 < bf g ef > < bf a ef>1  |
    %13
    < bf g ef >2 < bf g ef > < bf a ef>1 < bf g ef >2 < bf g ef > < bf a ef>2 bf4 c |
    %17
    ...
    c8 bf af g s2
    %29
    g4. f8 ef4 f < g ef bf> <bf g ef> f' d d\arpeggio ef c bf <c af ef>2. <c af ef>4 |
    %33
    c4\arpeggio d bf af <bf g ef c>1 \arpeggio bf4 c af g af bf <ef,c> <f d> |
    %37
    < g e c g>2 < g e c g> <g fs d a>1 < g e c g>2 < g e c g> <g fs d a>1
    %41
    < g e c g>2 < g e c g> <g fs d a>1 < g e c g>2 < g e c g> <g fs d a>1
    %45
    < bf g ef >2 < bf g ef > < bf a ef>1 < bf g ef >2 < bf g ef > < bf a ef>2 bf4 c  |
    ...
    c4\arpeggio d bf af <bf g ef c>1 \arpeggio bf4 c af g af bf <ef,c> <f d> |
    %69
    < g e c g>2 < g e c g> <g fs d a>1 \key c \major < g e c g>2 < g e c g> <g fs d a>1
    %73
    < g e c g>2 < g e c g> <g fs d a>1 < g e c g>2 < g e c g> <g fs d a>1
    %77
    < bf g ef >2 < bf g ef > < bf a ef>1 < bf g ef >2 < bf g ef > < bf a ef>1  |
    %81
    <c g e c>2 <c g e c> <d a fs d>1 < ef bf g ef> <f d bf g> <g e c g> |
    %86
...
leftOne = \relative c {
  ...
  %17
  c2 d c d < d bf f>2 < d bf f> c2 d4 c |
  %21
  c2 d s1 s1  s1 |
  %25
  %  \time 4/4
  ...
  %37
  %  \time 2/2
  < e g, c,>2 < e g, c,> < d g, c,>1 < e g, c,>2 < e g, c,> < d g, c,>1
  %41
  < e g, c,>2 < e g, c,> < d g, c,>1 < e g, c,>2 < e g, c,> < d g,>1 |
  %45
  < bf ef, >2 < bf' g ef>  < bf a ef >1
  < bf, ef, >2 < bf' g ef>  < bf a ef >2 bf4 c
  %49
  c2 d c d < d bf f> < d bf f> c2 d4 c |
  %53
  c2 d s1 s1  s1 |
  %57
  %  \time 4/4
  ...
  af,8 ef' af bf c bf af g f, c' af'4 < af bf,>2 |
  %69
  < e g, c,>2 < e g, c,> < d g, c,>1
  \key c \major < e g, c,>2 < e g, c,> < d g, >1
  < e g, c,>2 < e g, c,> < d g, c,>1 < e g, c,>2 < e g, c,> < d g, >1
  %77
  < bf ef, >2 < bf' g ef> < bf a ef >1
  < bf, ef, >2 < bf' g ef> < bf a ef >1
