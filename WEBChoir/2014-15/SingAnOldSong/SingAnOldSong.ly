...
soprano = \relative c' {
  ...
  %81
  a'2.~\> a2 r4\! R2.^\markup { \tiny \italic "rit." }
  r4 r fs8\f e \rm
  % 85
...
alto = \relative c' {
  ...
  e4 e fs8 a b4 a fs8 e d2 a'8 b16 ( cs ) d4 cs b8 a |
  b8 (a) fs4 a8 b16 ( cs ) d4 cs b8 a d2 fs,8 e d4 d fs8 a |
  e4 e fs8 a b4 a fs8 e d2.~ d R2. R2. \break |
  %104
...
tenor = \relative c' {
  ...
  e4 e fs8 a b4 a fs8 e d2 a'8 b16 ( cs ) d4 cs b8 a |
  b8 (a) fs4 a8 b16 ( cs ) d4 cs b8 a d2 fs,8 e d4 d fs8 a |
  e4 e fs8 a b4 a b8 d d2.~ d R2. R2. \break |
  %104
...
verse = \lyricmode {
  ...
  through eve -- ry tri -- al and test. __
  ...
  like those who came be -- fore. __
  We'll join all heav -- en's saints
  to praise the ever -- last -- ing Lord. __
  We'll join all heav -- en's saints
  to praise the ev -- er -- last -- ing Lord,
  ev -- er -- last -- ing Lord.
  Praise the Lord! __
